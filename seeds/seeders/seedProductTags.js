...
const seedProductTags = async () => {
  try {
    ...
    // This documentation was used as reference when using the .flat() method: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/flat
